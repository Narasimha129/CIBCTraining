...
/** Conformiq generated test case
	Verify__Login_with_valid_username_and_invalid_password
*/
public class Verify__Login_with_valid_username_and_invalid_password extends PageObjectBase
{

	public Verify__Login_with_valid_username_and_invalid_password()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Verify__Login_with_valid_username_and_invalid_password", "TC_Verify__Login_with_valid_username_and_invalid_password", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Verify__Login_with_valid_username_and_invalid_password","Step_1");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Verify__Login_with_valid_username_and_invalid_password","Step_2");

	Reporter.log("Step - 3- verify Login screen");

	testReport.fillTableStep("Step 3", "verify Login screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Verify__Login_with_valid_username_and_invalid_password","Step_3");
	}
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Verify__Login_with_valid_username_and_invalid_password");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
