...
/** Conformiq generated test case
	Verify_Successful_login__2_
*/
public class Verify_Successful_login__2_ extends PageObjectBase
{

	public Verify_Successful_login__2_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Verify_Successful_login__2_", "TC_Verify_Successful_login__2_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Verify_Successful_login__2_","Step_1");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Verify_Successful_login__2_","Step_2");

	Reporter.log("Step - 3- verify Home screen");

	testReport.fillTableStep("Step 3", "verify Home screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Verify_Successful_login__2_","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Verify_Successful_login__2_","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Verify_Successful_login__2_","Step_5");

	Reporter.log("Step - 6- verify Order Details screen");

	testReport.fillTableStep("Step 6", "verify Order Details screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Verify_Successful_login__2_","Step_6");
	}
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Verify_Successful_login__2_");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
